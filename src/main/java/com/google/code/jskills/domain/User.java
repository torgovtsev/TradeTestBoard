...
public class User implements Serializable {
	...
	public User(String password, String firstName, String secondName,
			...
			Integer age, String selectedEmail, String selectedSex,
	...
	private Set<UserUuid> userUuidEntities = new HashSet<UserUuid>(0);

	public User(String firstName, String lastName, String email,
			String password, String secretQuestion, String secretAnswer,
			String mobile, Boolean sex, int age, Date registrationDate,
