...
public class  TestActionPanel extends Panel{
	...
	public TestActionPanel(String id, final IModel<Test> model) {
		...
		add(new AjaxLink<Test>("editTest", model) {
			private static final long serialVersionUID = 1L;
			...
			public void onClick(AjaxRequestTarget target) {
		    	...
		    	setResponsePage(new EditTest(selectedTest));
				/*selectedTest = getModelObject();
